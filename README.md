...
*Демонстрация 1 — Графический интерфейс системы*
...
*Рисунок 1 — Примеры изображений после обработки*
...
*Рисунок 2 — Рост точности на тренировочном и валидационном наборах*

![График потерь](images/loss_plot.png)  
*Рисунок 3 — Снижение функции потерь*
